...
HD_PWD='E:/Code/Vivado/Lab 4/stopwatch/stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_Team3_Stopwatch_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab4_Team3_Stopwatch_fpga.tcl -notrace
