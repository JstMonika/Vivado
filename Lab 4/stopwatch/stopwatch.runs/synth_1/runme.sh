...
HD_PWD='E:/Code/Vivado/Lab 4/stopwatch/stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab4_Team3_Stopwatch_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab4_Team3_Stopwatch_fpga.tcl
