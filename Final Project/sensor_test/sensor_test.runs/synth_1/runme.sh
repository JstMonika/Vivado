...
HD_PWD='E:/Code/Vivado/Final Project/sensor_test/sensor_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sensor_test.tcl
