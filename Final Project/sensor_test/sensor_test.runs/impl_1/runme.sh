...
HD_PWD='E:/Code/Vivado/Final Project/sensor_test/sensor_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sensor_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sensor_test.tcl -notrace
