...
HD_PWD='E:/Code/Vivado/Lab 5/FPGA1/FPGA_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_TeamX_Musical_Scale_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab5_TeamX_Musical_Scale_fpga.tcl
