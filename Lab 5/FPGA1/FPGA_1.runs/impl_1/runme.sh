...
HD_PWD='E:/Code/Vivado/Lab 5/FPGA1/FPGA_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab5_TeamX_Musical_Scale_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab5_TeamX_Musical_Scale_fpga.tcl -notrace
